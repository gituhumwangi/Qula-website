  ...
  return (
    <nav className={`container ${sticky ? 'dark-nav' : ''}`}>
      ...
      <ul className={`nav-links ${mobileMenu ? 'show-mobile-menu' : 'hide-mobile-menu'}`}>
        ...
        <li>
          <Link to='about' smooth={true} offset={-135} duration={500} onClick={toggleMenu}>
            About Us
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link to='contactSection' smooth={true} offset={-75} duration={500} className='contact-us btn' onClick={toggleMenu}>
            Contact Us
          </Link>
        </li>
      </ul>
